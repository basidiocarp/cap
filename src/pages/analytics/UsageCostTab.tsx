...
export function UsageCostTab({ aggregate, sessions, trend }: Props) {
  if (!aggregate) {
    return <EmptyState>No usage data yet. Session cost data appears after Claude Code or Codex session transcripts are parsed.</EmptyState>
  }
        ...
        <>
          ...
          <ChartBox mih={250}>
            <LineChart
              ...
              dataKey='date'
              h={300}
              series={[{ color: 'fruiting.6', name: 'cost' }]}
              strokeWidth={2}
            />
          </ChartBox>
          ...
          <ChartBox mih={250}>
            <BarChart
              ...
              h={300}
              series={[
                { color: 'mycelium.6', name: 'input_tokens' },
                { color: 'spore.6', name: 'output_tokens' },
              ]}
              type='stacked'
            />
          </ChartBox>
