...
#
# Bumps version in package.json, runs quality checks, commits, tags, and optionally pushes.
...
[ -f package.json ] || die "Run from the repository root (where package.json is)"
